...
namespace org.javarosa.core.model.data
{
	...
	public class TimeData : IAnswerData, System.ICloneable
	{
		...
		virtual public System.String DisplayText
		{
			get
			{
				...
				return DateUtils.formatTime(ref d, DateUtils.FORMAT_HUMAN_READABLE_SHORT);
			}
		...
		//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
		public TimeData(ref System.DateTime d)
		{
			Value = d;
		}
		...
		public virtual System.Object Clone()
		{
			...
			//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
			return new TimeData(ref tempAux);
		}
		...
		*/
		...
		{
			//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
			return new UncastData(DateUtils.formatTime(ref d, DateUtils.FORMAT_ISO8601));
		}
