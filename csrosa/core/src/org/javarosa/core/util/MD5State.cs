...
namespace org.javarosa.core.util
{
    ...
    /// <summary> Fast implementation of RSA's MD5 hash generator in Java JDK Beta-2 or higher<br>
    ...
    class MD5State
    {
        /// <summary> 128-bit state </summary>
        internal long[] state;

        /// <summary> 64-bit character count</summary>
        internal long count;

        /// <summary> 64-byte buffer (512 bits) for storing to-be-hashed characters</summary>
