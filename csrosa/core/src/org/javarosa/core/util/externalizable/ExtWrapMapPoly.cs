...
namespace org.javarosa.core.util.externalizable
{
    ...
    public class ExtWrapMapPoly : ExternalizableWrapper
    {
        ...
        public ExtWrapMapPoly(System.Collections.Hashtable val)
            : this(val, null)
        {
        }
        ...
        public ExtWrapMapPoly(System.Type keyType)
            : this(keyType, false)
        {
        }
        ...
        public ExtWrapMapPoly(System.Type keyType, bool ordered)
        ...
        {
            //UPGRADE_TODO: Class 'java.util.HashMap' was converted to 'System.Collections.Hashtable' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javautilHashMap'"
            System.Collections.Hashtable h = ordered ? new OrderedHashtable() : new System.Collections.Hashtable();
