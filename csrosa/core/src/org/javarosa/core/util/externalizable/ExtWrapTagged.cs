...
namespace org.javarosa.core.util.externalizable
{
    ...
    {
        public static sbyte[] WRAPPER_TAG = new sbyte[] { Convert.ToSByte(0xff), Convert.ToSByte(0xff), Convert.ToSByte(0xff), Convert.ToSByte(0xff) }; //must be same length as PrototypeFactory.CLASS_HASH_SIZE
        ...
        public static void writeTag(System.IO.BinaryWriter out_Renamed, System.Object o)
        {
            ...
            {
                out_Renamed.Write((byte[])(Array)WRAPPER_TAG, 0, PrototypeFactory.CLASS_HASH_SIZE);
                ExtUtil.writeNumeric(out_Renamed, (long)WRAPPER_CODES[o.GetType()]);
            ...
            else
            {
                ...
                out_Renamed.Write((byte[])(Array)tag, 0, tag.Length);
            }
        }
        ...
        {
            {
                ...
                WRAPPER_CODES[typeof(ExtWrapNullable)] = 0x00;
                WRAPPER_CODES[typeof(ExtWrapList)] = 0x20;
                WRAPPER_CODES[typeof(ExtWrapListPoly)] = 0x21;
                WRAPPER_CODES[typeof(ExtWrapMap)] =  0x22;
                WRAPPER_CODES[typeof(ExtWrapMapPoly)] = 0x23;
                WRAPPER_CODES[typeof(ExtWrapIntEncodingUniform)] = 0x40;
                WRAPPER_CODES[typeof(ExtWrapIntEncodingSmall)] =  0x41;
            }
        }
    }
}