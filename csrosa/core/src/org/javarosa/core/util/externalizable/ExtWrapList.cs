...
namespace org.javarosa.core.util.externalizable
{
    ...
    public class ExtWrapList : ExternalizableWrapper
    {
        ...
        public ExtWrapList(ArrayList val)
            : this(val, null)
        {
        }
        public ExtWrapList(List<SelectChoice> val)
            : this(val, null)
        {
        }
        public ExtWrapList(List<Selection> val)
            : this(val, null)
        {
        }
        public ExtWrapList(ArrayList val, ExternalizableWrapper type)
        {
            if (val == null)
            {
        ...
        public ExtWrapList(List<Selection> val, ExternalizableWrapper type)
        {
            if (val == null)
            {
                throw new System.NullReferenceException();
        ...
        public ExtWrapList(System.Type type)
            : this(type, false)
        {
        }
        ...
        {
            return new ExtWrapList((ArrayList)val, type);
        }
