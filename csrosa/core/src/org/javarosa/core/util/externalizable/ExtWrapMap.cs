...
namespace org.javarosa.core.util.externalizable
{
    ...
    public class ExtWrapMap : ExternalizableWrapper
    {
        ...
        public ExtWrapMap(Dictionary<String,String> val)
            : this(val, null, null)
        {
        }

        public ExtWrapMap(System.Collections.Hashtable val)
            : this(val, null, null)
        {
        }
        ...
        public ExtWrapMap(System.Type keyType, System.Type dataType)
            : this(keyType, dataType, TYPE_NORMAL)
        {
        }

        public ExtWrapMap(System.Type keyType, ExternalizableWrapper dataType)
            : this(keyType, dataType, TYPE_NORMAL)
        {
        }
        ...
        public ExtWrapMap(System.Type keyType, System.Type dataType, int type)
