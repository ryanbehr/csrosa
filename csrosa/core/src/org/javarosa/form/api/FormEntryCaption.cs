...
namespace org.javarosa.form.api
{
    ...
    public class FormEntryCaption : FormElementStateListener
    {
        ...
        public static String TEXT_FORM_LONG = "long";
        public static String TEXT_FORM_SHORT = "short";
        public static String TEXT_FORM_AUDIO = "audio";
        public static String TEXT_FORM_IMAGE = "image";
        ...
        public void formElementStateChanged(TreeElement instanceNode,
                int changeFlags)
        {
            throw new SystemException("cannot happen");
        }
